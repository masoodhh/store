        ...
        child: Column(
          ...
          children: [
            ...
            LinkButton(
                ...
                onPressed: () {}),
            const SizedBox(height: 20),
            LinkButton(title: "Continue with Apple", prefixWidget: const Icon(Icons.apple), onPressed: () {}),
            const SizedBox(height: 20),
            Center(
              child: RichText(
                  text: TextSpan(text: "Already have an account? ", style: MyTextStyles.caption, children: [
                TextSpan(
                  text: "Sign In",
